...
class Featurizer(nn.Module):
    def __init__(
        ...
        layer_selection: list = "None", #int = None, 
    ...
    def _select_feature(self, features):
        ...
        if isinstance(feature, (list, tuple)) and isinstance(self.layer_selection, list) and len(self.layer_selection) > 0:
            feature = [feature[x] for x in self.layer_selection]
        # print(f"Layers: {self.layer_selection} \nNumber of features: {len(feature)}")
        return feature
