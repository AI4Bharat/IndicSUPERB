...
def get_downstream_args():
    ...
    parser.add_argument('-l', '--upstream_layer_selection', type=str, default="[]", help='Select a specific layer for the features selected by -s')
    ...
    # print(args.upstream_layer_selection
    # sys.exit(0)
    args.upstream_layer_selection = eval(args.upstream_layer_selection)
    print("layers",args.upstream_layer_selection)
    # sys.exit(0)
    backup_files = []
